...
\resumeItem{Implemented email templates based on Figma designs by using Maizzle with tailwind for CustomerIO, using liquid for dynamic properties and Litmus for testing.}
      \resumeItemListEnd
