...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeSubtitle{Providing support to first- and second-year university students, taking attendance, and grading coursework.}
      \resumeItemListStart
\resumeItem{Modules include: \\ Professional and Research Practice, Procedural Programming (\textbf{Java}), and Graphical User Interfaces (\textbf{React.js}).}
    \resumeItemListEnd
